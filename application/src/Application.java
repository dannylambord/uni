...
import java.util.Queue;
 ...
 {
 private Shopper[] tellers;
 private Queue<Shopper> custQueue;
...
public Application(int numberOfTellers)
 {
    tellers = new Shopper[numberOfTellers];
 custQueue = new LinkedList<Shopper>();
 totalCustomers = 0;
 totalTime = 0;
 }
 ...
 */
 ...
 @param c the customer
 */
 private void addToTeller(int i, Shopper c)
{
 tellers[i] = c;
...
public void remove(int i)
 ...
 // Update statistics
 totalCustomers++;
 totalTime = totalTime + c.getCurrentTime() - c.getArrivalTime();
